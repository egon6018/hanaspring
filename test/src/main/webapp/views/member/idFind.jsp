...
<body>
  <div class="main">
    <form action="<c:url value="/member/idFindimpl" />" name="idFindForm">
      <table>
        <tr>
        ...
        <tr>
          ...
          <td style="width: 80%;">
            ...
            <input id="memberEmail" type="text" class="emailText" name="memberEmail">
          </td>
        </tr>
      </table>
    </form>
    <div><input id="idFindBtn" type="image" src="<c:url value="/img/member/btn_confirm.gif" />" onclick="submit()"></div>
<%--  onclick="submit()  --%>
