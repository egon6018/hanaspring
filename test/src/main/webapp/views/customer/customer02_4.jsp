  ...
  <div class="communitySection2 container text-center">
    ...
    <div class="NoticeContent">
      <table>
        ...
        <tr>
          <th>작성일</th>
          <td>${qnaidx.qnaDate}</td>
        </tr>
        <tr>
          <td colspan="2">${qnaidx.qnaContent}</td>
        </tr>
      </table>
      <div>
        <input type="image" onclick="window.location.href = '<c:url value="/customer/customer02" />'"
