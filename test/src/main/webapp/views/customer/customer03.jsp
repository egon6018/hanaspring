...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="<c:url value="/index.jsp" />"><button class="homeBtn">H</button></a>
  ...
  <div class="communitySection2 container text-center">
    ...
    <div class="faq">
      <table>
        <tr>
          <td>질문1</td>
          <td onclick="window.location.href='customer03_1.jsp?no=1'">자주하는 질문모음입니다.</td>
        </tr>
        <tr>
          <td>질문2</td>
          <td onclick="window.location.href='customer03_1.jsp?no=2'">자주하는 질문모음입니다.</td>
        </tr>
        <tr>
          <td>질문3</td>
          <td onclick="window.location.href='customer03_1.jsp?no=3'">자주하는 질문모음입니다.</td>
        </tr>
        <tr>
          <td>질문4</td>
          <td onclick="window.location.href='customer03_1.jsp?no=4'">자주하는 질문모음입니다.</td>
        </tr>
        <tr>
          <td>질문5</td>
          <td onclick="window.location.href='customer03_1.jsp?no=5'">자주하는 질문모음입니다.</td>
        </tr>
      </table>
    </div>
  </div>
