  ...
  <div class="communitySection2 container text-center">
    ...
    <div class="NoticeContent">
      <table>
        <tr>
          <th>제목</th>
          <td>${noticeidx.noticeTitle}</td>
        </tr>
        <tr>
          <th>작성일</th>
          <td>${noticeidx.noticeDate}</td>
        </tr>
        <tr>
          <td colspan="2">${noticeidx.noticeContent}</td>
        </tr>
      </table>
      <div>
        <input type="image" onclick="window.location.href = '<c:url value="/community/community01" />'"
