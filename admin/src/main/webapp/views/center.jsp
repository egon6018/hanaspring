...
<script>
    let center_websocket = {
        stompClient: null,
        init:function(){
            let socket = new SockJS('${serverurl}/wss'); // 웹소켓 서버로 접속한다(기존 ws이 아닌 wss채널로)
            ...
            this.stompClient.connect({}, function(frame){
                ...
                this.subscribe('/send2',function(msg){
                    ...
                    $('#progress3').css('width',JSON.parse(msg.body).content3/100*100+'%');
                    $('#progress3').attr('aria-valuenow',JSON.parse(msg.body).content3/100*100);
